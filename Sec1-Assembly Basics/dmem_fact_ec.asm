...
INIT
  ...
  JMP END_FINAL               ; jumps over subroutine

.FALIGN                       ; aligns the subroutine
SUB_FACTORIAL                 ; start the subroutine

  CMPI R4, #0                 ; sets NZP (5 - 0)
  BRnz END_END                ; if the counter is neg or zero, end the subroutine
  ...
  ADD R1, R0, #0              ; B = A  
    ...
    BRnzp SUB_FACTORIAL       ; always goto SUB_FACTORIAL
