...
;; In ASCII, enter is 13 in decimal
;; Using a while loop, while (R0 != enter)
WHILE
	CMPIU R0, x0A	; set NZP(R0 - x0A)
	BRz END		    ; test R0 - 13 = 0? If yes, end the loop

	TRAP x00		; call the "TRAP_GETC" in os.asm to read charcter from keyboard
	TRAP x01		; call the "TRAP_PUTC" in os.asm to write character from R0 to ASCII display
